...
public class Tucson2PLibrary extends Library {
     ...
     */
    public boolean get_context_1(final Struct id) {
        if (this.context != null) {
            try {
                this.context.exit();
            } catch (final TucsonOperationNotPossibleException e) {
        ...
        this.context = TucsonMetaACC.getContext(this.agentId);
        return true;
    }
    ...
    public boolean in_2(final Term arg0, final Term arg1) {
        ...
        if (op.isResultSuccess()) {
            this.unify(arg0, op.getLogicTupleResult().toTerm());
        }
        return op.isResultSuccess();
    }
