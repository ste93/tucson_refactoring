...
public abstract class SpawnActivity implements Serializable, Runnable{
	...
	protected final LogicTuple in(LogicTuple tuple){
		if(aid != null)
			...
			try {
				return TupleCentreContainer.doBlockingOperation(TucsonOperation.inCode(), this.tcid, target, tuple);
			} catch (TucsonInvalidLogicTupleException e) {
				e.printStackTrace();
			} catch (TucsonOperationNotPossibleException e) {
				e.printStackTrace();
	...
	protected final LogicTuple rd(LogicTuple tuple){
		if(aid != null)
			...
			try {
				return TupleCentreContainer.doBlockingOperation(TucsonOperation.rdCode(), this.tcid, target, tuple);
			} catch (TucsonInvalidLogicTupleException e) {
				e.printStackTrace();
			} catch (TucsonOperationNotPossibleException e) {
				e.printStackTrace();
	...
	protected final LogicTuple no(LogicTuple tuple){
		if(aid != null)
			...
			try {
				return TupleCentreContainer.doBlockingOperation(TucsonOperation.noCode(), this.tcid, target, tuple);
			} catch (TucsonInvalidLogicTupleException e) {
				e.printStackTrace();
			} catch (TucsonOperationNotPossibleException e) {
				e.printStackTrace();
	...
	protected final LogicTuple inp(LogicTuple tuple){
		if(aid != null)
			...
			try {
				return TupleCentreContainer.doBlockingOperation(TucsonOperation.inpCode(), this.tcid, target, tuple);
			} catch (TucsonInvalidLogicTupleException e) {
				e.printStackTrace();
			} catch (TucsonOperationNotPossibleException e) {
				e.printStackTrace();
	...
	protected final LogicTuple rdp(LogicTuple tuple){
		if(aid != null)
			...
			try {
				return TupleCentreContainer.doBlockingOperation(TucsonOperation.rdpCode(), this.tcid, target, tuple);
			} catch (TucsonInvalidLogicTupleException e) {
				e.printStackTrace();
			} catch (TucsonOperationNotPossibleException e) {
				e.printStackTrace();
	...
	protected final LogicTuple nop(LogicTuple tuple){
		if(aid != null)
			...
			try {
				return TupleCentreContainer.doBlockingOperation(TucsonOperation.nopCode(), this.tcid, target, tuple);
			} catch (TucsonInvalidLogicTupleException e) {
				e.printStackTrace();
			} catch (TucsonOperationNotPossibleException e) {
				e.printStackTrace();
