...
public interface TupleTemplate extends Tuple{
    ...
    /**
     * specifies if the tuple template matches the tuple, or rather
     *  if tuples belongs to the set identified by the template.
     *
    ...
    /**
     * tries to change the tuple template object and the tuple argument
     * in order to meld information
     *
