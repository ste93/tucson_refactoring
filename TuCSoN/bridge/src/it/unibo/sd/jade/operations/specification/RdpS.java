...
public class RdpS extends AbstractTucsonSpecificationAction {
     ...
     *            specification tuple
     */
    public RdpS(final TucsonTupleCentreId t, final LogicTuple e,
    ...
    public ITucsonOperation executeAsynch(final EnhancedAsynchACC acc,
        ...
        return acc.rdpS(acc, this.event, this.guards, this.reaction, listener);
    }
    ...
    public ITucsonOperation executeSynch(final EnhancedSynchACC acc,
        ...
        return acc.rdpS(acc, this.event, this.guards, this.reaction, timeout);
    }
}
