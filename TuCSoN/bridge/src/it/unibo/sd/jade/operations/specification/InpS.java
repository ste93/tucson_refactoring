...
public class InpS extends AbstractTucsonSpecificationAction {
     ...
     *            specification tuple
     */
    public InpS(final TucsonTupleCentreId t, final LogicTuple e,
    ...
    public ITucsonOperation executeAsynch(final EnhancedAsynchACC acc,
        ...
        return acc.inpS(acc, this.event, this.guards, this.reaction, listener);
    }
    ...
    public ITucsonOperation executeSynch(final EnhancedSynchACC acc,
        ...
        return acc.inpS(acc, this.event, this.guards, this.reaction, timeout);
    }
}
